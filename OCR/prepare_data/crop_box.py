...
def main():
  gt_path = os.path.abspath('../data/trainset/labels/*')
  files = glob.glob(gt_path)
  rootImage = os.path.abspath('../data/trainset/images')
  
  outpath = os.path.abspath('../data/rec_train_data')
  os.makedirs(os.path.join(outpath, "img"), exist_ok=True)
